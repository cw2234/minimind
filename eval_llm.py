...
def main():
    ...
    parser.add_argument(
        "--top_p", default=0.95, type=float, help="nucleus采样阈值（0-1）"
    )
    parser.add_argument(
        "--open_thinking", default=0, type=int, help="是否开启自适应思考（0=否，1=是）"
    )
    parser.add_argument(
        "--historys",
        default=0,
    ...
    parser.add_argument(
        "--show_speed", default=1, type=int, help="显示decode速度（tokens/s）"
    )
    parser.add_argument(
        "--device",
